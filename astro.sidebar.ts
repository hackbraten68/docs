...
export const sidebar = [
	...
	group('start', {
		items: [
			'getting-started',
			group('start.welcome', {
				items: ['concepts/why-learning-hub', 'concepts/project-modules', 'concepts/to-begin'],
			}),
			group('start.beginnerTips', {
				items: ['tips/set-goal', 'tips/study-habits', 'tips/avoid-tutorial-hell', 'tips/marathon-mindset', 'tips/build-projects', 'tips/learn-to-get-unstuck'],
			}),
		],
	}),
